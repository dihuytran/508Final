...
<body>
    ...
    <div class="container">
        ...
        <div class="content mt-4">
            <p>Explore our offered classes! We have trainers specializing in everything from weight loss to olympic lifting,
                lets see what we can do for you!.</p>
            <button onclick="location.href='enroll.php'" class="btn btn-primary">Services</button>
        </div>
        <div class="content mt-4">
