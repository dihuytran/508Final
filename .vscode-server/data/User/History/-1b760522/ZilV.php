...
<head>
    ...
    <style>
        ...
        .column {
            ...
            height: 100%; /* Make columns occupy full height */
        }
    </style>
    <script>
...
<body>
    ...
    <div class="content mt-4 column">
        ...
        <button onclick="location.href='enroll.php'" class="btn btn-primary align-self-start">Classes</button>
    </div>
</div>
<div class="col-md-4">
    <div class="content mt-4 column">
        ...
        <button onclick="location.href='equipment.php'" class="btn btn-primary align-self-start">Equipment</button>
    </div>
</div>
<div class="col-md-4">
    <div class="content mt-4 column">
        <p>Manage your personal account settings, view your payment history, and update your profile without having
            to speak to anyone at our front desk!.</p>
        <button onclick="location.href='guest_dashboard.php'" class="btn btn-primary align-self-start">Account</button>
    </div>
</div>
        </div>
