        ...
        <div class="row">
            <div class="col-md-4">
                <div class="content mt-4 column">
                    ...
                    <button onclick="location.href='enroll.php'" class="btn btn-primary align-self-end">Classes</button>
                </div>
            </div>
            <div class="col-md-4">
                <div class="content mt-4 column">
                    ...
                    <button onclick="location.href='equipment.php'" class="btn btn-primary align-self-end">Equipment</button>
                </div>
            </div>
            <div class="col-md-4">
                <div class="content mt-4 column">
                    ...
                    <button onclick="location.href='guest_dashboard.php'" class="btn btn-primary align-self-end">Account</button>
                </div>
            </div>
        </div>
