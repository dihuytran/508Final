...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_class'])) {
    ...
    $formattedTime = date('H:i:s', strtotime($classTime));
    $dateTime = $formattedDate . ' ' . $formattedTime;

    $sql = "INSERT INTO class (class_name, capacity, class_date, class_time, class_type) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->execute([$className, $capacity, $formattedDate, $dateTime, $classType]);
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_class'])) {
    ...
    $sql = "UPDATE class SET class_name = ?, capacity = ?, class_date = ?, class_time = ? WHERE class_id = ?";
    $stmt = $conn->prepare($sql);
    $stmt->execute([$className, $capacity, $formattedDate, $dateTime, $classId]);
}
    ...
    <div class="row">
        <div class="col-md-6 form-column">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="classDate" class="form-control" placeholder="MM/DD/YYYY" required>
                </div>
                <div class="form-group">
                    <label>Class Time</label>
                    <input type="text" name="classTime" class="form-control" placeholder="HH:MM AM/PM" required>
                </div>
                <div class="form-group">
        ...
        <div class="col-md-6 form-column">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    <label>Class Date</label>
                    <input type="text" name="classDate" class="form-control" placeholder="MM/DD/YYYY">
                </div>
                <div class="form-group">
                    <label>Class Time</label>
                    <input type="text" name="classTime" class="form-control" placeholder="HH:MM AM/PM">
                </div>
                <div class="form-group">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars(date('h:i A', strtotime($class['class_time']))); ?></td>
