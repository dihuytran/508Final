        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <ol>
                    ...
                    <li><?php echo htmlspecialchars($history['action']); ?>:
                        <?php echo htmlspecialchars($history['item']); ?></li>
                    <?php endforeach; ?>
                </ol>
                <?php else: ?>
                    ...
                    <form id="editProfileForm" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name"
                                value="<?php echo htmlspecialchars($userInfo['member_name']); ?>" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone"
                                pattern="\(\d{3}\) \d{3}-\d{4}"
                                value="<?php echo htmlspecialchars($userInfo['phone_number']); ?>" required>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
