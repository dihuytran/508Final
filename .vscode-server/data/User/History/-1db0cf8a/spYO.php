    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary ml-2" data-toggle="modal" data-target="#editProfileModal">Edit Profile</button>
            </div>
        </div>
...
<?php elseif (isset($profileUpdateError)): ?>
            ...
            <div class="modal-body">
                <form id="editProfileForm" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlspecialchars($userInfo['member_name']); ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone" pattern="\(\d{3}\) \d{3}-\d{4}" value="<?php echo htmlspecialchars($userInfo['phone_number']); ?>" required>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
