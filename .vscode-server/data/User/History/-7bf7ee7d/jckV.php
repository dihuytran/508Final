<?php
require_once 'connection.php';  // Include your DB connection settings
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty(trim($_POST["email"]))) {
        ...
        $sql = "SELECT member_id FROM user WHERE email = :email";
    ...
    if (empty($name_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)) {
        $sql = "INSERT INTO user (member_name, email, password) VALUES (:name, :email, :password)";
